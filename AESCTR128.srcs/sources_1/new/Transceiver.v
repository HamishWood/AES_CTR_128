...
module Transceiver(
    input CLK100MHZ,
    input [127:0] TransmitMessage, //modify width to required bit width.
    output reg [127:0] ReceiverMessage = 0, //modify width to required bit width.
    input TransmitSend,
    ...
    //number of bytes per request, do not modify.
    parameter Format = 16;
    //ClkPerBit = clkHz/baud.
    parameter ClkPerBaud = 100000000/57600;
    ...
    always @ (posedge CLK100MHZ) begin
        case (TransState)
            ...
            ST_load: begin
                case (TPacketCounter)
                    15: TransPacket = TransmitMessage[7:0];
                    14: TransPacket = TransmitMessage[15:8];
                    13: TransPacket = TransmitMessage[23:16];
                    12: TransPacket = TransmitMessage[31:24];
                    11: TransPacket = TransmitMessage[39:32];
                    10: TransPacket = TransmitMessage[47:40];
                    9: TransPacket = TransmitMessage[55:48];
                    8: TransPacket = TransmitMessage[63:56];
                    7: TransPacket = TransmitMessage[71:64];
                    6: TransPacket = TransmitMessage[79:72];
                    5: TransPacket = TransmitMessage[87:80];
                    4: TransPacket = TransmitMessage[95:88];
                    3: TransPacket = TransmitMessage[103:96];
                    2: TransPacket = TransmitMessage[111:104];
                    1: TransPacket = TransmitMessage[119:112];
                    0: TransPacket = TransmitMessage[127:120];
            ...
            ST_busy: begin
                ...
                if (TransDone) begin
                    ...
                    end else if (TclkDelay == 100000) begin  //Prevent packets from being transmitted too quickly.
                        TransState = ST_load;
                        TclkDelay = 0;
                    end else begin
        ...
        case (ReceiverState)
            SR_idle: begin
                ...
                if (RPacketCounter == Format) begin
                    ReceiverFull = 1;
                end
                if (!ReceiverOn) begin
            ...
            SR_bundle: begin
                case (RPacketCounter)
                    ...
                    0: ReceiverMessage[127:120] = ReceiverPacket;
                    1: ReceiverMessage[119:112] = ReceiverPacket;
                    2: ReceiverMessage[111:104] = ReceiverPacket;
                    3: ReceiverMessage[103:96] = ReceiverPacket;
                    4: ReceiverMessage[95:88] = ReceiverPacket;
                    5: ReceiverMessage[87:80] = ReceiverPacket;
                    6: ReceiverMessage[79:72] = ReceiverPacket;
                    7: ReceiverMessage[71:64] = ReceiverPacket;
                    8: ReceiverMessage[63:56] = ReceiverPacket;
                    9: ReceiverMessage[55:48] = ReceiverPacket;
                    10: ReceiverMessage[47:40] = ReceiverPacket;
                    11: ReceiverMessage[39:32] = ReceiverPacket;
                    12: ReceiverMessage[31:24] = ReceiverPacket;
                    13: ReceiverMessage[23:16] = ReceiverPacket;
                    14: ReceiverMessage[15:8] = ReceiverPacket;
                    15: ReceiverMessage[7:0] = ReceiverPacket;
                endcase
                RecToggle = 0;
